        ...
        <el-dialog
            ...
            <div class="look activity">
              <el-form ref="form" label-width="130px">
                <el-form-item label="商家名称：">{{ look.name }}</el-form-item>
                <el-form-item label="商家地址：">{{ look.address }}</el-form-item>
                <el-form-item label="认证状态：">{{ look.pass == -1?'未审核':look.pass == 1?'通过':'未通过' }}</el-form-item>
                <el-form-item label="工商营业执照："><img :src="url+look.Industry" alt="" width="100%"></el-form-item>
